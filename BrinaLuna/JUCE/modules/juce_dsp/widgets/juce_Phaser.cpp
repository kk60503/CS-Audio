...
{
    // sawtooth wave(s)
//    osc.initialise ([] (SampleType x)
//                    {
//                        return juce::jmap (x,
//                                           SampleType (-juce::MathConstants<double>::pi),
//                                           SampleType (juce::MathConstants<double>::pi),
//                                           SampleType (-1),
//                                           SampleType (1));
//                    }, 128);
...
//                        }, 128);
    ...
    // sin wave
    osc.initialise ([] (SampleType x) { return std::sin (x); }, 128);
    
    // square wave
//    osc.initialise ([] (SampleType x) { return (x < 0) ? -1 : 1; }, 128);
